...
var allowedtags=[ 'a', 'abbr', 'acronym', 'b', 'blockquote', 'cite', 'code', 'pre', 'del', 'em', 'i', 'q', 'strike', 'strong'];
...
function updateLivePreview() {
	...
	gravatar += 's=32';
    		...
    		gravatar += '&amp;r=X';
		    document.getElementById('commentPreview').innerHTML = '			<ol class="commentlist">				<li id="comment-preview">					<div aria-live="polite">					' + cmnt + '					</div>				</li>			</ol>';
}
