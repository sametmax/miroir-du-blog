...
//
  var templates = {
    ...
    user_nav: Hogan.compile('<a href="#" class="icon-sprite icon-user dropdown-toggle" data-toggle="dropdown"></a><ul class="dropdown-menu"><li><a href="#user-info" data-toggle="modal"><i class="icon-user"></i>Voir les détails du compte</a></li><li class="divider"></li><li><a href="https://twitter.com/{{screen_name}}" target="_blank"><i class="icon-share-alt"></i>Voir le profil sur Twitter</a></li></ul>'),
    modal_header: Hogan.compile('<h3>Détails du compte <span class="download-date muted">au {{created_at_relative}}</span></h3>'),
    ...
    modal_account_details: Hogan.compile('<p>#{{id}} <span class="footer-label muted">Identifiant d\'utilisateur</span></p><p class="truncated">{{created_at_relative}} <span class="footer-label muted">Inscrit</span></p>'),
...
//
  ...
  exports.init = function () {
    ...
    .bind('invalidSearch', function (e) {
      e.preventDefault();
      $(this)
        .attr('data-original-title', 'Votre requête doit comporter au moins deux caractères.')
        .tooltip('show');
    });
  ...
  (function(exports) {
    exports.base = {
      init: function () {
        $('.navbar-search .search-query').attr('placeholder', 'Rechercher dans tous les Tweets');
  ...
  (function (exports){
    ...
    exports.localizeStrings = function() {
      ...
      document.title = "Votre archive Twitter";
      $('#footer-text').append("Ceci est une archive hors ligne de vos Tweets sur Twitter. Utilisez les mois ci-dessus pour parcourir l\'archive.");
      var compose_new_tweet = "Écrire un nouveau Tweet";
