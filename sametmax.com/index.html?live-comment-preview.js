...
var allowedtags=['a', 'abbr', 'acronym', 'b', 'blockquote', 'cite', 'code', 'del', 'em', 'i', 'q', 'strike', 'strong', 'pre'];
...
function updateLivePreview() {
	...
	gravatar += 's=32';
    		...
    		gravatar += '&amp;r=X';
		    document.getElementById('commentPreview').innerHTML = '			<ol class="commentlist">				<li id="comment-preview">					<img src="retro" alt="" class="avatar avatar-32" width="32" height="32"/>					<cite>' + name + '</cite> Says:					<br />					' + cmnt + '				</li>			</ol>';
}
